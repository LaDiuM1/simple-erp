...
interface Props {
  ...
  columns?: number;
  /** 긴 상세 정보가 후속 조작 영역을 가리는 화면에서는 false 로 문서 흐름에 둔다. */
  sticky?: boolean;
}
 ...
 */
export default function GenericHeaderDetails({ fields, columns = 2, sticky = true }: Props) {
  return (
    <HeaderDetailsRoot sticky={sticky}>
